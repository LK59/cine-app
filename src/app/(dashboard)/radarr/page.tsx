...
export default function RadarrPage() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem("movieView") as ViewMode | null;
            ...
            <>
              <div className="card divide-y divide-white/5">
                {visible.map((movie, i) => (
                  ...
                  >
                    <PosterImage src={poster(movie)} alt={movie.title} aspectRatio="" className="h-14 w-10 shrink-0 rounded" />
