        ...
        {PLAYER_NAV.map(({ panel, labelKey, icon: Icon }) => {
          ...
          return (
            <button
              ...
              className={`relative flex h-11 shrink-0 items-center gap-4 overflow-hidden rounded-lg pl-[0.85rem] pr-3 text-left text-sm font-medium transition-colors active:bg-white/15 active:delay-75 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-500 ${
                isActive
