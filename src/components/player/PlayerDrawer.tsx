 ...
 * d'une affiche sur un écran qui n'en a déjà pas de trop. Le bouton reste donc seul en haut à
 * gauche, posé dans le dégradé de la bannière où il ne cache rien.
 *
 * Son ouverture passe par l'URL, comme les panneaux : sur Android, le geste de retour doit
 * refermer le tiroir plutôt que quitter l'écran. Le bouton qui l'ouvre n'est pas ici mais dans
 * l'en-tête de l'écran cinéma mobile, à la place de la flèche de sortie — un seul bouton en haut
 * à gauche, qui mène à tout, plutôt que deux qui se disputent le coin.
 */
