...
export function CinemaModeToggle({
  ...
  return (
    <div
      className="fixed top-4 z-10 flex -translate-x-1/2 items-center gap-1 rounded-full p-1 player-bar"
    ...
    >
      <button
        ...
        className={`rounded-full px-4 py-1.5 text-sm font-medium transition-colors ${TV_NAV_RING} ${
          mode === "movies" ? "bg-white text-ink" : "text-muted hover:text-white"
        }`}
      >
        {t("cinema.moviesTab")}
      </button>
      <button
        ...
        className={`rounded-full px-4 py-1.5 text-sm font-medium transition-colors ${TV_NAV_RING} ${
          mode === "series" ? "bg-white text-ink" : "text-muted hover:text-white"
        }`}
      >
        {t("cinema.seriesTab")}
      </button>
