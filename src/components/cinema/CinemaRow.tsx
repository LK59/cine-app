...
export function CinemaRow({
  ...
  return (
    // data-cinema-row: CinemaClient's own scroll-end effect uses this to find each row's top
    // edge and settle the pane there — see its doc comment for why that's JS-driven rather than
    // CSS scroll-snap.
